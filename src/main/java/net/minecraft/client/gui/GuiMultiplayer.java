...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    private String BungeeSpoofBtn() {
        return Paradise.INSTANCE.bungeeHack ? "Bungee: " + ColorHelper.color + "aYes" : "Bungee: " + ColorHelper.color + "cNo";
    }
    private String AutoIP() {
        return Paradise.INSTANCE.autoIP ? "Auto IP: " + ColorHelper.color + "aYes" : "Auto IP: " + ColorHelper.color + "cNo";
    }
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(69, this.width / 2 + 4 + 150, this.height - 52, 100, 20, "UUID Spoof"));
        this.buttonList.add(new GuiButton(10, this.width / 2 + 4 + 150, this.height - 28, 100, 20, AutoIP()));
        IpBungeeBtn = new GuiTextField(10, this.fontRendererObj, this.width / 2 - 222, this.height - 26, 66, 16);
        IpBungeeBtn.setText(Paradise.INSTANCE.ipBungeeHack);
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
                Paradise.INSTANCE.autoIP = !Paradise.INSTANCE.autoIP;
                button.displayString = AutoIP();
            }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        else
        {
            ...
            Paradise.INSTANCE.ipBungeeHack = IpBungeeBtn.getText();
        }
    }
